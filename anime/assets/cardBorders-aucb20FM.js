import{j as i}from"./index-Dy2rfYbN.js";const x=[{glow:"#FFD700"},{glow:"#42A5F5"},{glow:"#F48FB1"},{glow:"#00C853"},{glow:"#B3E5FC"},{glow:"#FF1744"},{glow:"#CE93D8"},{glow:"#FF006E"},{glow:"#CFD8DC"},{glow:"#00E5FF"}],s=`
...
`;let t=!1;function b(){if(t||typeof document>"u")return;t=!0;const a=document.createElement("style");a.textContent=s,document.head.appendChild(a)}function p(a){const e=String(a);let o=5381;for(let r=0;r<e.length;r++)o=(o<<5)+o^e.charCodeAt(r);return Math.abs(o)%10}function d({color:a,variant:e}){const o=e%2===0?"corner-spin":"corner-spin-rev",r=(3+e%5*.8).toFixed(1)+"s",n=4+e%3,F={position:"absolute",width:n,height:n,borderRadius:"50%",background:a,boxShadow:`0 0 6px ${a}, 0 0 12px ${a}`,pointerEvents:"none",zIndex:5};return e%3!==0?null:i.jsxs(i.Fragment,{children:[i.jsx("span",{style:{...F,top:-n/2,left:-n/2,animation:`${o} ${r} linear infinite`}}),i.jsx("span",{style:{...F,bottom:-n/2,right:-n/2,animation:`${o} ${r} linear infinite reverse`}})]})}export{d as C,x as V,p as h,b as i};
